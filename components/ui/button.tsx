	...
	},
	{
		...
		component: ({ className, ...props }) => (
			<button
				{...props}
				className={cn(
					'relative rounded-xl border border-[#333] bg-main-background px-4 py-2 transition-all duration-200',
					'text-primary-foreground hover:bg-[#333]/40',
					className
				)}
			/>
		),
			...
			return (
				<button
					...
					className={cn(
						...
						'bg-[#fffaec] dark:hover:bg-[#999999]',
						className
					)}
				>
