		...
		<div className={styles.container}>
			...
			<div className={styles.bottomPart}>
				<div className={styles.inputContainer}>
					<Text variant='generate-effect' className={styles.label}>
						Email
					</Text>
					<Input
						...
						value={email}
						maxLength={35}
						className={`${styles.input} ${isSent && styles.untouchable}`}
					/>
				</div>
				{email !== '' &&
					(checkValidEmail() ? (
				...
				{(checkValidEmail() && name !== '') || !touched ? (
					<Button
						...
						className={`${styles.button} ${isSent && styles.untouchable}`}
							...
							<>
								<p
									className={`${styles.message} ${
										message.includes('Oops') && styles.messageError
									}`}
								>
									{message}
								</p>
